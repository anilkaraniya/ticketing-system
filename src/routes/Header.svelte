<script>
  ...
  import logo from "$lib/images/ospc-logo.svg";
  import github from "$lib/images/github.svg";
</script>

<header>
  <div class="corner">
    <a href="https://github.com/OSPClub" target="_blank">
      <img src={logo} alt="OSP Club" />
    </a>
  </div>
  ...
  <div class="corner">
    <a href="https://github.com/anilkaraniya" target="_blank">
